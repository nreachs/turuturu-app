...
class AutoTruckEntries extends StatefulWidget {
  @override
  _AutoTruckEntriesState createState() => _AutoTruckEntriesState();
}

class _AutoTruckEntriesState extends State<AutoTruckEntries> {
  CollectionReference _autoTrucklFinanceInfo =
