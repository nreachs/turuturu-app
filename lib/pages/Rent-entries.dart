...
class RentEntriesForm extends StatefulWidget {
  @override
  _RentEntriesFormState createState() => _RentEntriesFormState();
}

class _RentEntriesFormState extends State<RentEntriesForm> {
  CollectionReference _RentlFinanceInfo =
